    ...
    >
        <div class="flex flex-col gap-4 pb-2">
            ...
            <AlertDialog.Description
                class="flex flex-col text-foreground/80 text-sm gap-0.5"
            >
                <span class="overflow-wrap"
                    ><b class="font-black italic">Name:</b>
                    {downloadWallpaper.Name}</span
                >
                <span class="overflow-wrap"
                    ><b class="font-black italic">Size:</b>
                    {downloadWallpaper.Size}</span
                >
                <span class="overflow-wrap"
                    ><b class="font-black italic">Type:</b>
                    {downloadWallpaper.Type}</span
                >
            </AlertDialog.Description>
        </div>
        <div class="flex w-full items-center justify-center gap-2">
            ...
            <AlertDialog.Action class="flex w-full" tabindex={-1}>
                <Button.Root
